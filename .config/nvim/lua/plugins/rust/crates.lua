return {
  ...
  keys = {
    ...
    { "<leader>cv", "<cmd>lua require('crates').show_versions_popup()<cr>", silent = true, desc = "Show Versions" },
    { "<leader>cf", "<cmd>lua require('crates').show_features_popup()<cr>", silent = true, desc = "Show Features" },
    {
      "<leader>cd",
    ...
    { "<leader>ca", "<cmd>lua require('crates').update_all_crates()<cr>", silent = true, desc = "Update All Crates" },
    {
      "<leader>cU",
    ...
    { "<leader>cR", "<cmd>lua require('crates').open_repository()<cr>", silent = true, desc = "Open Repository" },
    {
      "<leader>cD",
